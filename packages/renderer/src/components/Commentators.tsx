        ...
        <div key={field.id} className="mb-4">
          ...
          <div className="flex flex-col gap-2 mt-2">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel htmlFor={`commentators.${commentatorNum}.name`}>
                    Name
                  </FormLabel>
                  <FormControl>
                    <Input
                      {...field}
                      id={`commentators.${commentatorNum}.name`}
                    ></Input>
                  </FormControl>
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel
                    htmlFor={`commentators.${commentatorNum}.pronouns`}
                  >
                    Pronouns
                  </FormLabel>
                  <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel htmlFor={`commentators.${commentatorNum}.twitter`}>
                    Twitter
                  </FormLabel>
                  <FormControl>
                    <Input
